    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 flex flex-wrap items-center justify-between gap-4"><p className="text-blue-600">Manage payments, learners and credentials.</p><div className="flex gap-2"><Link to="/"><Button variant="outline" size="sm">Review 104,317 users</Button></Link><Link to="/" search={{ hideUsers: true }}><Button variant="outline" size="sm">Hide homepage count</Button></Link></div></div>
